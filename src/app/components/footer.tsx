...
export default function Footer(){
  return (
    <footer className="bg-black">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center bg-black px-[75px] py-[30px]">
          <div className="text-[#FFFFFF] md:w-[50%] w-[100%]">
          ...
          <div className="flex md:mt-0 mt-[20px]">
            <input type="text" placeholder="Enter Your Email"
              className="bg-[#FF9F0D] text-[#FFFFFF] py-[5px] px-[10px] md:py-[10px] md:px-[20px] mr-2"
            />
          ...
          <hr className="my-4 border-[#FF9F0D] mx-[70px]" />

      <div className="mx-[70px]">
        <div className="grid grid-cols-2 gap-3 md:gap-[20px] px-0 md:px-[35px] py-6 lg:py-8 md:grid-cols-4">
          <div className="">
            ...
            <ul className="text-[#FFFFFF]  font-medium">
              ...
              <li className="flex gap-[16.5px]">
                ...
                <div className="ml-1">
                  <h2 className="text-[18px] text-[#FFFFFF] font-normal">
                    Opening Houres
                  </h2>
          ...
          <div className="mt-10 md:mt-0">
            ...
            <ul className="text-[#FFFFFF]  font-medium gap-[14px]">
              <li className="flex gap-[16.5px]">
                ...
                <div className="ml-1">
                  ...
                  <h3 className="text-[18px] font-normal text-[#FFFFFF]">
                    Keep Your Business
                  </h3>
                </div>
              </li>
        ...
        <div className="w-[100%] px-4 py-6 bg-[#4F4F4F] md:flex md:items-center md:justify-between">
          <span className="text-sm text-[#FFFFFF] text-center sm:text-center">
            © 2024 by <a href="https://flowbite.com/">Mahnoor Shaikh</a>. All Rights
            Reserved.
          </span>
